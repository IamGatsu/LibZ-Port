...
public class DrawTabHelper {
     ...
     *
     * @param client      A Minecraft instance.
     * @param context     The GuiGraphics of the render method.
     ...
     */
    public static void drawTab(Minecraft client, GuiGraphicsExtractor context, Screen screenClass, int x, int y, int mouseX, int mouseY) {
        if (client != null && client.player != null && ConfigInit.CONFIG.inventoryButton && (Object) screenClass instanceof Tab) {
            ...
            if (list != null) {
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (inventoryTab.shouldShow(client)) {
                        ...
                        // NOTE: GuiGraphics' texture-drawing API has changed several times across recent
                        // Minecraft releases (e.g. added RenderType/atlas-size parameters). Verify this
                        // blit(...) call against the actual 26.2 GuiGraphics signature and adjust if needed.
                        context.blit(LibzClient.tabTexture, xPos, isSelectedTab ? y - 23 : y - 21, textureX, 0, 24, isSelectedTab ? 27 : isFirstTab ? 25 : 21, 256, 256);
                        if (inventoryTab.getTexture() != null) {
                            ...
                            context.item(inventoryTab.getItemStack(client), xPos + 4, y - 17);
                        }
            ...
            if (shownTooltip != null) {
                context.setTooltipForNextFrame(shownTooltip, mouseX, mouseY);
            }
        }
    }
